...
<div class="media-gallery">
    <div class="gallery-container">
        <h2 class="gallery-title">میڈیا گیلری</h2>
        <div class="gallery-wrapper">
            <div class="gallery-slider">
                <div class="gallery-item">
                    <img src="https://qurtabacity.com/wp-content/uploads/2022/05/285136902_5365795480145672_8381392960174129080_n.jpg" alt="تقریب" class="gallery-image">
                    <div class="gallery-caption">یوم تاسیس کی تقریب ٢٠٢٣</div>
                </div>
                <div class="gallery-item">
                    <img src="assets/images/event2.jpg" alt="اجتماع" class="gallery-image">
                    <div class="gallery-caption">سالانہ اجتماع منصورہ</div>
                </div>
                <div class="gallery-item">
                    <img src="assets/images/event3.jpg" alt="سیمینار" class="gallery-image">
                    <div class="gallery-caption">علمی سیمینار برائے طلبہ</div>
                </div>
                <div class="gallery-item">
                    <img src="assets/images/event4.jpg" alt="کنونشن" class="gallery-image">
                    <div class="gallery-caption">نوجوانوں کا عظیم اجتماع</div>
                </div>
                <div class="gallery-item">
                    <img src="assets/images/event5.jpg" alt="تربیتی نشست" class="gallery-image">
                    <div class="gallery-caption">خواتین کی تربیتی نشست</div>
                </div>
            </div>
...
<script>
    class GallerySlider {
        ...
        next() {
            this.currentIndex = (this.currentIndex + 1) % (this.itemCount - 2);
            this.updateSlider();
            this.resetAutoSlide();
        }

        prev() {
            this.currentIndex = (this.currentIndex - 1 + (this.itemCount - 2)) % (this.itemCount - 2);
            this.updateSlider();
            this.resetAutoSlide();
        }
